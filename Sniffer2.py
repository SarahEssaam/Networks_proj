    ...
    def run(self ):
        ...
        while True:
            ...
            while (MyWidget.start.getPacket()):
                ...
                # print('\nEthernet Frame:')
                Data += "\nEthernet Frame:" + TAB_1 + "Destination:" + str(eth.dest_mac) + "Source: " + str(
                ...
                if eth.proto == 8:
                    ipv4 = IPv4(eth.data)
                    Data += TAB_2 + 'Protocol: ' + str(ipv4.proto) + ' Source:' + str(ipv4.src) + 'Target:' + str(
                        ipv4.target)
                    ...
                    Data += TAB_1 + 'IPv4 Packet:' + TAB_2 + 'Version:' + str(ipv4.version) + 'Header Length:' + str(
                    ...
                    if ipv4.proto == 1:
                        ...
                        Data += TAB_1 + 'ICMP Packet:' + TAB_2 + 'Type: ' + str(icmp.type) + "Code:" + str(
                            icmp.code) + "Checksum:" + str(icmp.checksum) + TAB_2 + 'ICMP Data:' + str(
                    ...
                    # TCP
                        ...
                        info += str(tcp.src_port) + "->" + str(tcp.dest_port) + "ACK=" + str(
                            tcp.flag_ack) + "len =" + str(
                            len(tcp.data))
                        ...
                        Data += TAB_1 + 'TCP Segment:' + TAB_2 + 'Source Port:' + str(
                            tcp.src_port) + "Destination Port:" + str(tcp.dest_port) + TAB_2 + 'Sequence:' + str(
                            tcp.sequence) + " Acknowledgment:" + str(tcp.acknowledgment)
                        Data += TAB_2 + 'Flags:' + TAB_3 + 'URG:' + str(tcp.flag_urg) + 'ACK' + str(
                            tcp.flag_ack) + 'PSH' + str(tcp.flag_psh) + TAB_3 + 'RST:' + str(
                            tcp.flag_rst) + 'SYN' + str(
                            tcp.flag_syn) + 'FIN' + str(tcp.flag_fin)
                        l.append(tcp.data)
                        l.append(info)
                        if len(tcp.data) > 0:
                    ...
                    # UDP
                        ...
                        Data += TAB_1 + 'UDP Segment:' + TAB_2 + 'Source Port:' + str(
                            udp.src_port) + 'Destination Port:' + str(udp.dest_port) + 'Length' + str(udp.size)
                        info += str(udp.src_port) + "->" + str(udp.dest_port) + "len =" + str(
